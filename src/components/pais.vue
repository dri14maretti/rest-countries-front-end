			...
			<v-col class="d-flex">
				...
				<v-list>
					<v-list-item>
						<v-list-item-content
							><v-list-item-title
								>Nome: {{ paisRecebido.name }}</v-list-item-title
							>
						</v-list-item-content></v-list-item
					><v-list-item>
						<v-list-item-content
							><v-list-item-title
								>Capital: {{ paisRecebido.capital }}</v-list-item-title
							>
						</v-list-item-content></v-list-item
					><v-list-item>
						<v-list-item-content
							><v-list-item-title
								>Região:
								<a class="link-regiao" v-on:click="abrirRegiao()">{{
									paisRecebido.region
								}}</a></v-list-item-title
							>
						</v-list-item-content></v-list-item
					><v-list-item>
						<v-list-item-content
							><v-list-item-title
								>Sub-região: {{ paisRecebido.subregion }}</v-list-item-title
							>
						</v-list-item-content></v-list-item
					><v-list-item>
						<v-list-item-content
